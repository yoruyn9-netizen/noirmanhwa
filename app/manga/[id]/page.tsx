...
import { fetchChapters, Manga } from '@/lib/mangaApi';
      ...
      <div className="flex flex-col md:flex-row gap-12 mb-16">
        <div className="relative w-full md:w-80 flex-shrink-0">
          <div className="aspect-[2/3] rounded-[3rem] overflow-hidden border border-white/10 shadow-2xl bg-[#0a0a0f]">
            <SafeImage src={`https://picsum.photos/seed/${id}/600/900`} alt="Manga" />
          </div>
        </div>

        <div className="flex-1 space-y-8">
          <h1 className="text-4xl font-black uppercase tracking-tighter leading-none text-glow">Manga Signal</h1>
          <div className="grid grid-cols-2 gap-4">
             <BookmarkButton manga={{ id, source, title: 'Manga Title', cover: '' }} />
