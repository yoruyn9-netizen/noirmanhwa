...
export const metadata: Metadata = {
  title: 'NoirManhwa | Real-Time Manhwa Discovery',
  description: 'Experience the ultimate manhwa reading platform with real-time API integration and zero dummy data.',
};
