...
import { Bookmark, Play, ArrowRight, Zap, BookOpen } from 'lucide-react';
          ...
          {bookmarks.map((manga) => (
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <h3 className="text-[10px] font-black uppercase tracking-tight text-white truncate group-hover:text-accent transition-colors">{manga.title}</h3>
                <p className="text-[7px] font-black text-accent uppercase tracking-widest mt-1">Status: {manga.status}</p>
              </div>
