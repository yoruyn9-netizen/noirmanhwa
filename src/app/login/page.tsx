...
export default function LoginPage() {
  const { user, loginWithGoogle, loginAsAdmin, isLoading, error, clearError } = useAuthStore();
      ...
      <div className={cn(
        ...
        <div className="text-center space-y-4">
          ...
          <div className="space-y-1">
            <h1 className="text-4xl font-black tracking-tighter uppercase text-glow">Authorize</h1>
            <p className="text-[10px] font-black text-muted-foreground uppercase tracking-[0.5em] opacity-40">Establish Neural Link</p>
          </div>
        </div>
        ...
        <div className="space-y-6">
          ...
          <div className="relative">
            ...
            <div className="relative flex justify-center">
              ...
              >
                {isAdminMode ? 'Back to Google' : 'Admin Protocol (Dev)'}
              </button>
            </div>
          </div>
          ...
          {isAdminMode && (
            <form onSubmit={handleAdminLogin} className="space-y-4 animate-in slide-in-from-top-4 duration-500">
              <div className="p-4 bg-yellow-500/10 border border-yellow-500/20 rounded-xl flex items-center gap-4">
                ...
                <p className="text-[8px] font-black text-yellow-500 uppercase tracking-widest">⚠️ Development Only - Jangan pakai di production</p>
              </div>
        ...
        <div className="text-center">
          <p className="text-[8px] font-black text-neutral-600 uppercase tracking-[0.3em]">NoirManhwa Network Security v4.2</p>
        </div>
      </div>
    </div>
  );
