...
function UsersAdminPage() {
  return (
    <div className="max-w-4xl mx-auto space-y-12 pb-32 animate-in fade-in duration-1000">
      ...
      <Tabs defaultValue="premium" className="space-y-10">
        <TabsList className="bg-[#0a0a0f]/60 border border-white/5 p-1.5 rounded-2xl h-auto">
          <TabsTrigger value="premium" className="px-10 py-3 rounded-xl text-[9px] font-black uppercase tracking-widest data-[state=active]:bg-accent data-[state=active]:text-white transition-all">
            PREMIUM PROTOCOLS
          </TabsTrigger>
          <TabsTrigger value="ban" className="px-10 py-3 rounded-xl text-[9px] font-black uppercase tracking-widest data-[state=active]:bg-red-600 data-[state=active]:text-white transition-all">
            ACCESS TERMINATION
          </TabsTrigger>
        </TabsList>
